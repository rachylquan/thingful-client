...
const TokenService = {
  ...
  clearAuthToken() {
    console.log('clearing the auth token');
  ...
  _getMsUntilExpiry(payload) {
    /*
      ...
      the 'exp' value is in seconds, need to conver to ms, so * 1000
  ...
  queueCallbackBeforeExpiry(callback) {
    ...
    /*
      ...
      the callback is passed in as an argumanet so could be anything,
